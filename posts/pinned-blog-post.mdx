...
In the your posts frontmatter add a new filed, pin. This will be a boolean value.
...
In the blog index you'll most likely have a query so that you can fetch your posts and pass them to the MDXRenderer. Add the new filed value to the frontmatter.
