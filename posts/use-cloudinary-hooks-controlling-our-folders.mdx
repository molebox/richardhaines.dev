...
Following on from my article about the use-cloudinary useSearch hook - [use-cloudinary - useUpload hook](https://richardhaines.dev/use-cloudinary-hooks-use-search/), this time we'll be streamlining our code and diving into some of whats possible with when manipulating our cloudinary folders.
